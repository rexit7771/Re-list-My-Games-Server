    ...
    <section className="bg-white dark:bg-gray-900">
      <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
        <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
          <img
            alt=""
            src="../../public/images/Login(4).jpeg"
        ...
        <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
          <div className="max-w-xl lg:max-w-3xl">
            ...
            <h2 className="mt-6 text-2xl font-bold text-white sm:text-3xl md:text-4xl text-blue-900">
              Welcome to <span className="text-neutral-200">Re-List</span> My
              Games 🎮
            </h2>

            <p className="mt-4 leading-relaxed text-white/90">
              Here you can List your favorite Games, and also find your favorite
              games.
            </p>
